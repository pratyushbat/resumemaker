...
@Component({
  ...
  template: `
     <header>
        <div class="row">
            <a href="homecss#main-menu" id="main-menu-toggle" class="menu-toggle" aria-label="Open main menu">
        ...
        <nav id="main-menu" class="main-menu" aria-label="Main menu">
            <a href="homecss#main-menu-toggle" id="main-menu-close" class="menu-close" aria-label="Close main menu">
       ...
       <a href="homecss#main-menu-toggle" class="backdrop" tabindex="-1" hidden></a>
    </header>
   <main>
        <section id="first">
